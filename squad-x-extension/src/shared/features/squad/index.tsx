              ...
              <div className="relative flex h-full items-center gap-[10px]">
                ...
                <div className="flex flex-col">
                  <div className="flex gap-1">
                    <span className="text-sm font-semibold text-[#16120F]">Bonksquads</span>
